...
편의점(CS2)/병원(HP8)/카페(CE7)는 내부 DB에 배치 적재하지 않고 실시간으로 조회한다 (설계 근거:
무장애 상세 enrichment가 필요 없고, 편의점/카페는 전국 단위로는 배치 대상으로 삼기엔 너무 큼.
카페는 TourAPI에 대응 contentTypeId가 없기도 하다).
